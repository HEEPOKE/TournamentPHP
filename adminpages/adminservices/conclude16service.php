...
if ($position == 'A1_4'|| $position == 'A2_4') {
    $Positiontour = 'A1_2';
} else if ($position == 'A3_4' || $position == 'A4_4') {
    $Positiontour = 'A2_2';
} else if ($position == 'B1_4' || $position == 'B2_4') {
    $Positiontour = 'B1_2';
} else if ($position == 'B3_4' || $position == 'B4_4') {
    $Positiontour = 'B2_2';
}
...
$sql3 = "INSERT INTO `match_winner`(`tour_id`, `team_id`, `round_position`, `round_number`) VALUES ($tour_id,'$w','$round_position','4')";

$sql3u = "UPDATE `match_winner` 
SET `team_id`= $w,
`round_number`= '4' WHERE tour_id = '$tour_id'";

$sql4 = "INSERT INTO `tournament`(`teamA_id`, `teamA_score`, `teamB_id`, `teamb_score`, `round_position`, `round_number`, `round_id`, `tour_position`) 
VALUES ('$w','','','','$round_position','4','$z', '$Positiontour')";
