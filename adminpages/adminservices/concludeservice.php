...
$tourposition = "SELECT tour_position FROM `tournament` WHERE tour_id = '$tour_id'";
...
if ($position == 'A1' || $position == 'A2') {
    $Positiontour = 'A1_4';
} else if ($position == 'A3' || $position == 'A4') {
    $Positiontour = 'A2_4';
} else if ($position == 'A5' || $position == 'A6') {
    $Positiontour = 'A3_4';
} else if ($position == 'A7' || $position == 'A8') {
    $Positiontour = 'A4_4';
} else if ($position == 'B1' || $position == 'B2') {
    $Positiontour = 'B1_4';
} else if ($position == 'B3' || $position == 'B4') {
    $Positiontour = 'B2_4';
} else if ($position == 'B5' || $position == 'B6') {
    $Positiontour = 'B3_4';
} else if ($position == 'B7' || $position == 'B8') {
    $Positiontour = 'B4_4';
}
...
// echo $member_idA1 . '<br>';
// echo $score_killA1 . '<br>';
// echo $score_deathA1 . '<br>';
// echo $score_assistA1 . '<br>';
// echo $is_mvpA1 . '<br>';
// echo $main_playerA1 . '<br>';
...
// echo $member_idA2 . '<br>';
// echo $score_killA2 . '<br>';
// echo $score_deathA2 . '<br>';
// echo $score_assistA2 . '<br>';
// echo $is_mvpA2 . '<br>';
// echo $main_playerA2 . '<br>';
...
// echo 'member_idB1..' . $member_idB1 . '<br>';
// echo $score_killB1 . '<br>';
// echo $score_deathB1 . '<br>';
// echo $score_assistB1 . '<br>';
// echo $is_mvpB1 . '<br>';
// echo $main_playerB1 . '<br>';
...
$sql3 = "INSERT INTO `match_winner`(`tour_id`, `team_id`, `round_position`, `round_number`) VALUES ($tour_id,'$w','$round_position','8')";

$sql3u = "UPDATE `match_winner` 
SET `team_id`= $w,
`round_number`= '8' WHERE tour_id = '$tour_id'";

// echo $Positiontour;
$sql4 = "INSERT INTO `tournament`(`teamA_id`, `teamA_score`, `teamB_id`, `teamb_score`, `round_position`, `round_number`, `round_id`, `tour_position`)
VALUES ('$w','','','','$round_position','8','$z','$Positiontour')";
