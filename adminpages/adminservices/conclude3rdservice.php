...
if ($position == 'AFinal' || $position == 'BFinal') {
    $Positiontour = '3rd';
} 
...
$sql3 = "INSERT INTO `match_winner`(`tour_id`, `team_id`, `round_position`, `round_number`) VALUES ($tour_id,'$w','3rd','03')";

$sql3u = "UPDATE `match_winner` 
SET `team_id`= $w,
`round_number`= '03' WHERE tour_id = '$tour_id'";

$sql4 = "INSERT INTO `tournament`(`teamA_id`, `teamA_score`, `teamB_id`, `teamb_score`, `round_position`, `round_number`, `round_id`, `tour_position`) 
VALUES ('$w','','0','','3rd','03','$z', '$Positiontour')";
