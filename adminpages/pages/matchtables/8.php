                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-white">
                                        <button onclick="window.location.href='?adminpages=seeconclude8&tour_id=<?php echo $tour_id; ?>'" class="btn btn-info text-white" style="width:100px; height:40px;" type="button">
                                            <i class="fa-solid fa-eye"></i> ดู
                                        </button>
                                    </td>
                                    <td class="text-white">
                                        <button onclick="window.location.href='?adminpages=conclude8&tour_id=<?php echo $tour_id; ?>'" class="btn btn-warning text-white" type="button">
