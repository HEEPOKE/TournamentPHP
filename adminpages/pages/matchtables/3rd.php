                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-white">
                                        <button onclick="window.location.href='?adminpages=seeconclude3rd&tour_id=<?php echo $tour_id; ?>'" class="btn btn-info text-white" style="width:100px; height:40px;" type="button">
                                            <i class="fa-solid fa-eye"></i> ดู
                                        </button>
                                    </td>
                                    <td class="text-white">
                                        <button onclick="window.location.href='?adminpages=conclude3rd&tour_id=<?php echo $tour_id; ?>'" class="btn btn-warning text-white" type="button">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <center><img src="../assets/icons/logo_champion_white.png" alt="" width="200" height="250"></center>
