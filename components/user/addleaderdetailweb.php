...
?>
<form action="Services/AddleaderdetailService.php?member_id=<?php echo $member_id ?>" method="POST" enctype="multipart/form-data">
    <div class="profile-pic pic-top">
        ...
        <input class="fileup" id="img_profile" name="img_profile" type="file" accept="image/.png, .jpg, .jpeg" onchange="loadFile(event)" />
        <div class="profile-pic2  pic-top2">
            <img src="assets/icons/camera.png" class="rounded-circle spanimg bottomright" alt="" onclick="$('#img_profile').click();" />
        </div>
    </div>
            ...
            <div class="modal fade" id="icons" tabindex="-1" aria-labelledby="iconsLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body modeladdleader-moblie">
